...
# Conf settings
ENV PHP_CONF_FILE=/etc/php/5.6/fpm/conf.d/20-system.ini \
    PHP_CONF_FILE_CLI=/etc/php/5.6/cli/conf.d/20-system.ini \
...
# Pool settings
ENV PHP_POOL_FILE=/etc/php/5.6/fpm/pool.d/20-system.pool.conf \
...
RUN docker-php-ext-install bcmath zip bz2 mbstring xsl gettext mcrypt \
